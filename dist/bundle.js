...
function(t,o){"use strict";function n(t,o){if(!(t instanceof o))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(o,"__esModule",{value:!0});var e=function(){function t(o){n(this,t),this._token=o,this._apiVersion="v1",this._apiUrl="https://api.stackable.space"}return t.prototype.getContainerItems=function(t,o){this._get("containers/"+t+"/items",function(t,n){o(t,n)})},t.prototype._get=function(t,o){var n=this._apiUrl+"/"+this._apiVersion+"/"+t+"?token="+this._token;$.ajax({url:n,type:"GET",context:document.body,success:function(t){o(!1,t)},error:function(t){o(t,!1)}})},t}();o["default"]=e},/*!********************************!*\
  ...
  \********************************/
function(t,o,n){(function(t){"use strict";function e(t){return t&&t.__esModule?t:{"default":t}}function i(t,o){if(!(t instanceof o))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(o,"__esModule",{value:!0});var a=n(11),s=e(a),r=function(){function o(){i(this,o),t.observable(this),this.stackable=new s["default"](STACK_ID);var n=window.localStorage.getItem(LOCALSTORAGE_KEY);n?this._posts=n&&JSON.parse(n)||[]:this.initData()}return o.prototype.getPostById=function(t){return this._posts.filter(function(o){return o._id===t})[0]},o.prototype.initData=function(){var o=this;this.stackable.getContainerItems(CONTAINER_ID,function(n,e){o._posts=e.data,o.saveToStorage(),o.trigger(t.SE.POSTS_CHANGED,o._posts)})},o.prototype.saveToStorage=function(){window.localStorage.setItem(LOCALSTORAGE_KEY,JSON.stringify(this._posts))},o}(),c=new r;c.on(t.VE.LOAD_POSTS,function(){c.trigger(t.SE.POSTS_CHANGED,c._posts)}),c.on(t.VE.RESET_DATA,function(){c.initData(),c.trigger(t.SE.POSTS_CHANGED,c._posts)}),t.control.addStore(c),o["default"]=c}).call(o,n(1))}]);
